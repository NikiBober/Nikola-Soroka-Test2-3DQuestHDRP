...
public class EnemyNew : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        GameObject playerObject = GameObject.Find("Ellen");
        player = playerObject.GetComponent<CQPlayerObject>();
        unit = playerObject.GetComponent<CQExamplePlayer>();
    }
